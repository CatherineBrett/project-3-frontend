      ...
      <div className="flex flex-col lg:flex-row items-center justify-between space-y-6 lg:space-y-0 lg:space-x-10 max-w-6xl mx-auto m-5">
        <div className="text-center lg:text-left space-y-4 max-w-xl p-4">
          ...
          <p className="text-gray-700">
            This full-stack application was made by Michael, Conor and Catherine
            as part of General Assembly's Software Engineering Immersive
            Bootcamp. We built our own backend and frontend using Express,
            Mongoose, MongoDB, and React.
          </p>
          <p className="text-gray-700">
            We wanted to create a space for General Assembly students past and
            present to share advice on getting the most out of their courses and
            bootcamps. Anyone is welcome to view the advice other students have
            contributed, and if you would like to share a tip or two of your
            own, then you will need to{" "}
            <Link
              to="/signup"
